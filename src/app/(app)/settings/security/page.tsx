...
export default function Security() {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      const errorMessage =
        err?.data?.message || err?.message || "Failed to change password. Please check your credentials.";
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full border border-gray-200 rounded-lg px-4 py-2.5 pr-10 text-sm focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400"
            />
            <button
              type="button"
